1.
Опишите какого типа будут объявлены ниже переменные
...
7.
Что будет выведенно на экране при следующей компиялции
...
17.
В каких строчках будет ошибка компиляции, и ниже опишите почему
```
#include <iostream>
